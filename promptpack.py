...
class PromptPackApp:
    ...
    def build_gui(self):
        ...
        ttk.Checkbutton(self.root, text="Live Preview", variable=self.enable_preview, command=self.toggle_preview_window).grid(row=2, column=1, sticky='w')
    ...
    def configure_settings(self):
        ...
        ttk.Button(win, text="Save", command=lambda: (save_settings({
            **self.settings,
    ...
    border-radius: 5px;
    overflow-x: auto;
    white-space: pre; /* previene il wrapping */
    word-break: normal; /* impedisce la rottura di parole */
    ...
    def select_files(self):
        ...
        ttk.Button(selector, text="Confirm Selection", command=lambda: (
